...
if __name__ == "__main__":
	#rrpn_test_COCOTEXT("829", "exp3", "vgg16_faster_rcnn_iter_300000.caffemodel", "train")
	#rrpn_test_COCOTEXT("829", "exp3", "vgg16_faster_rcnn_iter_300000.caffemodel", "val")
	#joint_test_rrpn_ICDAR2015("17-203", "exp0", "VGG16")
	#rrpn_test_MSRA("717", "exp0", "vgg16_faster_rcnn_iter_50000.caffemodel", "test")
	#rrpn_test_MSRA("717", "exp0", "vgg16_faster_rcnn_iter_50000.caffemodel", "train")
	
	#rrpn_test_MSRA("717", "exp3", "vgg16_faster_rcnn_iter_90000.caffemodel", "test")
	#rrpn_test_MSRA("719", "exp0", "vgg16_faster_rcnn_iter_30000.caffemodel", "test")
	#rotation_demo.rrpn_test_crop("test", "exp", "vgg16_faster_rcnn_iter_450000.caffemodel", "test", 0)
	#rrpn_test_MSRA("729", "exp3", "vgg16_faster_rcnn_iter_150000.caffemodel", "test")
	#rrpn_test_ICDAR2013("1101", "exp1", "vgg16_faster_rcnn_iter_240000.caffemodel", "test")
	#rrpn_test_MSRA("17-126", "exp0", "vgg16_faster_rcnn_iter_60000.caffemodel", "test")
	#rrpn_test_ICDAR2013("1210", "exp0", "vgg16_faster_rcnn_iter_270000.caffemodel", "test")
	#rrpn_test_ICDAR2015("829", "exp3", "vgg16_faster_rcnn_iter_300000.caffemodel", "test")
	#rrpn_test_ICDAR2015("1010", "exp1", "vgg16_faster_rcnn_iter_255000.caffemodel", "test")
	#rrpn_test_ICDAR2015("1018", "exp0", "vgg16_faster_rcnn_iter_315000.caffemodel", "test")
	#rrpn_test_ICDAR2015("17-222", "exp0", "vgg16_faster_rcnn_iter_240000.caffemodel", "test")
	rrpn_test_ICDAR2015("test", "exp", "vgg16_faster_rcnn_iter_450000.caffemodel", "test")
	#rrpn_test_ICDAR2015_modelfusion([{"model_name":"vgg16_faster_rcnn_iter_240000.caffemodel", "day": "1021", "exp": "exp1", "ratio":[0.125, 0.2, 0.5], "conf":0.85}, {"model_name":"vgg16_faster_rcnn_iter_270000.caffemodel", "day": "1210", "exp": "exp0", "ratio":[0.2, 0.5, 1], "conf": 0.79}], "test")
	#rrpn_test_MSRA("729", "exp3", "vgg16_faster_rcnn_iter_165000.caffemodel", "test")
	#rrpn_test_BOT("1010", "exp1", "vgg16_faster_rcnn_iter_255000.caffemodel", "noodle")
	#rrpn_test_MSRA("829", "exp3", "vgg16_faster_rcnn_iter_300000.caffemodel", "test_wtf")
	#print get_bot_img('noodle')
	#roidb = get_MSRA("test")
	#for roi in roidb:
		#vis_image(roi["image"], roidb["boxes"])
