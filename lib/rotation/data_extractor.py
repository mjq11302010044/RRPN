...
def get_rroidb(mode):	
	...
	#L_ICDAR2015_RRC = get_ICDAR2015_RRC_TRAIN(mode)
	#print "L_ICDAR2015_RRC:", len(L_ICDAR2003_TEST)

	#L_VEDAI_train = get_VEDAI_vihicle(mode, 1, 1024)
	...
	#L_DATASET.extend(L_ICDAR2015_RRC)
	#L_DATASET.extend(L_VEDAI_train)
	...
	#for roi in L_ICDAR2015_RRC:
	#	rrc_count += len(roi["boxes"])
	#print "the text instance of ICDAR2015_RRC: ", rrc_count
