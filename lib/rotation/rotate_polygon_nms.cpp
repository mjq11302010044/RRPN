...
static char __pyx_k_rotation_rotate_polygon_nms[] = "rotation.rotate_polygon_nms";
static char __pyx_k_home_shiki_alice_workspace_Rota[] = "/home/shiki-alice/workspace/Rotation-Faster-RCNN/py-faster-rcnn/lib/rotation/rotate_polygon_nms.pyx";
...
static PyMethodDef __pyx_mdef_8rotation_18rotate_polygon_nms_1rotate_gpu_nms = {"rotate_gpu_nms", (PyCFunction)__pyx_pw_8rotation_18rotate_polygon_nms_1rotate_gpu_nms, METH_VARARGS|METH_KEYWORDS, 0};
...
#endif
{
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "rotation.rotate_polygon_nms")) {
      if (unlikely(PyDict_SetItemString(modules, "rotation.rotate_polygon_nms", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     cdef int boxes_num = dets.shape[0]
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_8rotation_18rotate_polygon_nms_1rotate_gpu_nms, NULL, __pyx_n_s_rotation_rotate_polygon_nms); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
